...
test("Assignment1 - Test1", async({page})=>
{
await page.route (
    '**/api/events**',
    async route => {
...
const assignmentApiUtils = new AssignmentApiUtils( page);
  
await assignmentApiUtils.loginAndGoToEvents(emailAddress, password);
...
test.only("Assignment1 - Test2", async({page})=>
{
await page.route (
    '**/api/events**',
    async route => {
...
const assignmentApiUtils = new AssignmentApiUtils(emailAddress, password, page);
  
await assignmentApiUtils.loginAndGoToEvents();
...
console.log("banner Visibility" + await banner.isVisible());
